...
fclose($file);
                                        ...
                                        $querypilihsegitiga = mysqli_query($koneksi, "SELECT * FROM bangun_ruang WHERE bangun_ruang='segitiga'") or die(mysqli_error($koneksi)); //query menampilkan bangun_ruang: segitiga
                                        ...
                                        mysqli_query($koneksi, "UPDATE bangun_ruang SET jumlah='$qty' WHERE bangun_ruang='segitiga'") or die(mysqli_error($koneksi)); //query upate qty
